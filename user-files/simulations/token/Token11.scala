...
class Token11 extends Simulation {
	...
	val scn = scenario("Token11")
		.exec(http("request_0")
			...
			.headers(headers_1)
			.check(bodyBytes.is(RawFileBody("Token11_0001_response.txt"))),
            http("request_2")
			.get("/_matrix/client/img/logo.png")
			.headers(headers_2)
			.check(bodyBytes.is(RawFileBody("Token11_0002_response.txt"))))
			.check(bodyBytes.is(RawFileBody("Token11_0000_response.txt"))))
		.pause(5)
		.exec(http("request_3")
			.post("/_matrix/client/api/v1/login")
			.headers(headers_3)
			.body(RawFileBody("Token11_0003_request.txt"))
			...
			.headers(headers_4)
			.check(bodyBytes.is(RawFileBody("Token11_0004_response.txt"))),
            http("request_5")
			...
			.headers(headers_5)
			.body(RawFileBody("Token11_0005_request.txt"))
			.check(bodyBytes.is(RawFileBody("Token11_0005_response.txt"))),
            http("request_6")
			...
			.headers(headers_4)
			.check(bodyBytes.is(RawFileBody("Token11_0006_response.txt"))),
            http("request_7")
			.get("/_matrix/client/app/home/home.html")
			.headers(headers_7)
			.check(bodyBytes.is(RawFileBody("Token11_0007_response.txt"))),
            http("request_8")
			...
			.headers(headers_4)
			.check(bodyBytes.is(RawFileBody("Token11_0008_response.txt"))),
            http("request_9")
			.get("/_matrix/client/img/logo-small.png")
			.check(bodyBytes.is(RawFileBody("Token11_0009_response.txt"))),
            http("request_10")
			...
			.headers(headers_4)
			.check(bodyBytes.is(RawFileBody("Token11_0010_response.txt"))),
            http("request_11")
			...
			.headers(headers_4)
			.check(bodyBytes.is(RawFileBody("Token11_0011_response.txt"))),
            http("request_12")
			.get("/_matrix/client/api/v1/publicRooms")
			.headers(headers_4)
			.check(bodyBytes.is(RawFileBody("Token11_0012_response.txt"))),
            http("request_13")
			.get("/_matrix/client/app/recents/recents.html")
			.headers(headers_7)
			.check(bodyBytes.is(RawFileBody("Token11_0013_response.txt"))),
            http("request_14")
			.get("/_matrix/client/img/close.png")
			.check(bodyBytes.is(RawFileBody("Token11_0014_response.txt"))))
			.check(bodyBytes.is(RawFileBody("Token11_0003_response.txt"))))
