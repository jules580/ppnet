...
class computesale14 extends Simulation {
...
/*	setUp(
	...
	splitUsers(10) into (rampUsers(10) over (10 seconds)) separatedBy(10 seconds),
	heavisideUsers(10) over(20 seconds)).throttle(
