...
class RecordedSimulateSendMessageVector2 extends Simulation {
...
before{
	...
	object Login{
		...
		.exec(http("Login user")
			...
			.get("/_matrix/client/r0/sync?filter=0&timeout=30000&_cacheBuster=1468424606158&access_token=${token}")
			.headers(headers_14)
			.check(status.is(200)),
			...
			.check(status.is(304)),
            http("sync filter")
			.get("/_matrix/client/r0/sync?filter=0&timeout=30000&since=s1540_1239_764_7_1_2&access_token=${token}")
			.headers(headers_14)
			.check(status.is(200)),
            http("cancel image")
	...
	object Param{
		val param=exec(http("Param initial")
			.options("/_matrix/client/r0/rooms/${table}%3Amatrix.allmende.io/state/m.room.power_levels/?access_token=${token}")
			.headers(headers_13)
			.resources(http("Set Param")
			.put("/_matrix/client/r0/rooms/${table}%3Amatrix.allmende.io/state/m.room.power_levels/?access_token=${token}")
			.headers(headers_16)
			...
			.check(status.is(304)),
            http("Liste event")
			.get("/_matrix/client/r0/sync?filter=0&timeout=30000&since=s1547_1239_764_7_1_2&access_token=${token}")
			.headers(headers_14)
			.check(status.is(200)),
            http("member image")
	...
	object Communicate{
		val communicate=exec(http("List Guest")
			.options("/_matrix/client/r0/rooms/${table}%3Amatrix.allmende.io/invite?access_token=${token}")
			.headers(headers_11)
			.resources(http("Invite Guest")
			.post("/_matrix/client/r0/rooms/${table}%3Amatrix.allmende.io/invite?access_token=${token}")
			.headers(headers_12)
			.body(RawFileBody("RecordedSimulateSendMessageVector_0061_request.txt"))
			.check(status.is(200)),
            http("Event communication")
			.get("/_matrix/client/r0/sync?filter=0&timeout=30000&since=s1548_1239_764_7_1_2&access_token=${token}")
			.headers(headers_14)
			.check(status.is(200)))
			.check(status.is(200)))
		.pause(5)
		...
		object Typing{
			...
			.options("/_matrix/client/r0/rooms/${table}%3Amatrix.allmende.io/typing/%40{login}%3Amatrix.allmende.io?access_token=${token}")
			.headers(headers_13)
			...
			.check(status.is(200)),
            http("Typing event")
			.get("/_matrix/client/r0/sync?filter=0&timeout=30000&since=s1548_1239_765_7_1_2&access_token=${token}")
			.headers(headers_14)
			.check(status.is(200)))
			.check(status.is(200)))
		.pause(2)
