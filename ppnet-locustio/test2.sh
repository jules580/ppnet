...
xterm -e 'ssh '$2' locust -f '$1' --master --host=http://192.168.2.77:30000; bash' &
sleep 10
xterm -e 'ssh '$3' locust -f '$1' --slave --master-host='$2' --host=http://192.168.2.77:30000; bash'&
sleep 10
xterm -e 'ssh '$4' locust -f '$1' --slave --master-host='$2' --host=http://192.168.2.77:30000'
