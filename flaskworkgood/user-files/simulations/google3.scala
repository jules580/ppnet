...
class google3 extends Simulation {
val feeder=jsonUrl("http://104.154.241.96:5050/test.json").random
...
before{
	...
	object Index{
		val feeders=jsonUrl("http://104.154.241.96:5050/test.json").random
		...
		object Login{
			 val feeder =csv("login.csv").random
			val feeders=jsonUrl("http://104.154.241.96:5050/test.json")
