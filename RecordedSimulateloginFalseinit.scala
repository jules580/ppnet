...
before{
	...
	object Index{
		val index=exec(http("Init")
			...
			.check(status.is(200)),
            http("presence")
			.put("/_matrix/client/api/v1/presence/%400.0.0.0:3000re%3Amatrix.allmende.io/status?access_token=MDAyMGxvY2F0aW9uIG1hdHJpeC5hbGxtZW5kZS5pbwowMDEzaWRlbnRpZmllciBrZXkKMDAxMGNpZCBnZW4gPSAxCjAwMmRjaWQgdXNlcl9pZCA9IEB0ZXN0cmU6bWF0cml4LmFsbG1lbmRlLmlvCjAwMTZjaWQgdHlwZSA9IGFjY2VzcwowMDFkY2lkIHRpbWUgPCAxNDY3NzEzNDU5NzczCjAwMmZzaWduYXR1cmUgk-KH11UPLq7RDpDYOuebPksAl4PqvHHAHXbC3Xn0iWwK")
			.headers(headers_3)
		...
		.exec(http("login")
			...
			.check(status.is(200)),
            http("DisplayName")
			.get("/_matrix/client/api/v1/profile/%400.0.0.0:3000re%3Amatrix.allmende.io/displayname?access_token=-KoZEs_wGWHzx-8K")
			.headers(headers_12)
			.check(status.is(200)),
			...
			.check(status.is(200)),
            http("profile info")
			.get("/_matrix/client/api/v1/profile/%400.0.0.0:3000re%3Amatrix.allmende.io/avatar_url?access_token=-KoZEs_wGWHzx-8K")
			.headers(headers_12)
			.check(status.is(200)),
