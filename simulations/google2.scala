...
val feeder=jsonUrl("http://192.168.2.77:5050/test.json").random
...
before{
	...
	object Index{
		val feeders=jsonUrl("http://192.168.2.77:5050/test.json").random
		...
		object Login{
			 val feeder =csv("login.csv").random
			val feeders=jsonUrl("http://192.168.2.77:5050/test.json")
