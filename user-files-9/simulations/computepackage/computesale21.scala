...
class computesale21 extends Simulation{
before{
...
.assertions(
	...
	details("Post").failedRequests.percent.is(0),
	details("Post").requestsPerSec.lessThan(10),
details("Post").requestsPerSec.between(100, 1000),
