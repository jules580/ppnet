...
class RecordedSimulatecreatetchat extends Simulation {
	...
	val scn = scenario("RecordedSimulatecreatetchat")
		.exec(http("request_0")
			.get("/_matrix/client/")
			.headers(headers_0)
			...
			.headers(headers_1)
			.check(bodyBytes.is(RawFileBody("RecordedSimulatecreatetchat_0001_response.txt"))),
            http("request_2")
			.get("/_matrix/client/img/logo.png")
			.headers(headers_2)
			.check(bodyBytes.is(RawFileBody("RecordedSimulatecreatetchat_0002_response.txt"))))
			.check(bodyBytes.is(RawFileBody("RecordedSimulatecreatetchat_0000_response.txt"))))
		.pause(68)
		.exec(http("request_3")
			...
			.headers(headers_4)
			.check(bodyBytes.is(RawFileBody("RecordedSimulatecreatetchat_0004_response.txt"))),
            http("request_5")
			.get(uri3 + "")
			.headers(headers_4)
			.check(bodyBytes.is(RawFileBody("RecordedSimulatecreatetchat_0005_response.txt"))))
			.check(bodyBytes.is(RawFileBody("RecordedSimulatecreatetchat_0003_response.txt"))))
		.pause(34)
		.exec(http("request_6")
			.post("/_matrix/client/v2_alpha/register")
			.headers(headers_6)
			.body(RawFileBody("RecordedSimulatecreatetchat_0006_request.txt"))
			.resources(http("request_7")
			.post("/_matrix/client/v2_alpha/register")
			.headers(headers_6)
			.body(RawFileBody("RecordedSimulatecreatetchat_0007_request.txt"))
			.check(bodyBytes.is(RawFileBody("RecordedSimulatecreatetchat_0007_response.txt"))),
            http("request_8")
			...
			.headers(headers_3)
			.check(bodyBytes.is(RawFileBody("RecordedSimulatecreatetchat_0008_response.txt"))),
            http("request_9")
			...
			.headers(headers_9)
			.body(RawFileBody("RecordedSimulatecreatetchat_0009_request.txt"))
			.check(bodyBytes.is(RawFileBody("RecordedSimulatecreatetchat_0009_response.txt"))),
            http("request_10")
			...
			.headers(headers_3)
			.check(bodyBytes.is(RawFileBody("RecordedSimulatecreatetchat_0010_response.txt"))),
            http("request_11")
			...
			.headers(headers_9)
			.body(RawFileBody("RecordedSimulatecreatetchat_0011_request.txt"))
			.check(bodyBytes.is(RawFileBody("RecordedSimulatecreatetchat_0011_response.txt"))),
            http("request_12")
			.get("/_matrix/client/app/home/home.html")
			.headers(headers_3)
			.check(bodyBytes.is(RawFileBody("RecordedSimulatecreatetchat_0012_response.txt"))),
            http("request_13")
			...
			.headers(headers_3)
			.check(bodyBytes.is(RawFileBody("RecordedSimulatecreatetchat_0013_response.txt"))),
            http("request_14")
			...
			.headers(headers_3)
			.check(bodyBytes.is(RawFileBody("RecordedSimulatecreatetchat_0014_response.txt"))),
            http("request_15")
			.get("/_matrix/client/api/v1/publicRooms")
			.headers(headers_3)
			.check(bodyBytes.is(RawFileBody("RecordedSimulatecreatetchat_0015_response.txt"))),
            http("request_16")
			.get("/_matrix/client/app/recents/recents.html")
			.headers(headers_3)
			.check(bodyBytes.is(RawFileBody("RecordedSimulatecreatetchat_0016_response.txt"))),
            http("request_17")
			.get("/_matrix/client/img/logo-small.png")
			.headers(headers_17)
			.check(bodyBytes.is(RawFileBody("RecordedSimulatecreatetchat_0017_response.txt"))),
            http("request_18")
			...
			.headers(headers_3)
			.check(bodyBytes.is(RawFileBody("RecordedSimulatecreatetchat_0018_response.txt"))),
            http("request_19")
			.get("/_matrix/client/img/close.png")
			.headers(headers_17)
			.check(bodyBytes.is(RawFileBody("RecordedSimulatecreatetchat_0019_response.txt"))),
            http("request_20")
			.get("/_matrix/client/api/v1/events?access_token=MDAyMGxvY2F0aW9uIG1hdHJpeC5hbGxtZW5kZS5pbwowMDEzaWRlbnRpZmllciBrZXkKMDAxMGNpZCBnZW4gPSAxCjAwMmRjaWQgdXNlcl9pZCA9IEB0ZXN0cmU6bWF0cml4LmFsbG1lbmRlLmlvCjAwMTZjaWQgdHlwZSA9IGFjY2VzcwowMDFkY2lkIHRpbWUgPCAxNDY3NzEyNzIyNDI0CjAwMmZzaWduYXR1cmUgOxhZLQzYw8DK9HPSEBK_iwci6VQFuaa3s6D0N4DcV1cK&from=s8_4_2_1_1_1&timeout=30000")
			.headers(headers_3)
			.check(bodyBytes.is(RawFileBody("RecordedSimulatecreatetchat_0020_response.txt"))))
			.check(status.is(401))
			.check(bodyBytes.is(RawFileBody("RecordedSimulatecreatetchat_0006_response.txt"))))
		.pause(28)
		.exec(http("request_21")
			.get("/_matrix/client/api/v1/events?access_token=MDAyMGxvY2F0aW9uIG1hdHJpeC5hbGxtZW5kZS5pbwowMDEzaWRlbnRpZmllciBrZXkKMDAxMGNpZCBnZW4gPSAxCjAwMmRjaWQgdXNlcl9pZCA9IEB0ZXN0cmU6bWF0cml4LmFsbG1lbmRlLmlvCjAwMTZjaWQgdHlwZSA9IGFjY2VzcwowMDFkY2lkIHRpbWUgPCAxNDY3NzEyNzIyNDI0CjAwMmZzaWduYXR1cmUgOxhZLQzYw8DK9HPSEBK_iwci6VQFuaa3s6D0N4DcV1cK&from=s8_4_2_1_1_1&timeout=30000")
			.headers(headers_3)
			.check(bodyBytes.is(RawFileBody("RecordedSimulatecreatetchat_0021_response.txt"))))
		.pause(32)
		.exec(http("request_22")
			.get("/_matrix/client/api/v1/events?access_token=MDAyMGxvY2F0aW9uIG1hdHJpeC5hbGxtZW5kZS5pbwowMDEzaWRlbnRpZmllciBrZXkKMDAxMGNpZCBnZW4gPSAxCjAwMmRjaWQgdXNlcl9pZCA9IEB0ZXN0cmU6bWF0cml4LmFsbG1lbmRlLmlvCjAwMTZjaWQgdHlwZSA9IGFjY2VzcwowMDFkY2lkIHRpbWUgPCAxNDY3NzEyNzIyNDI0CjAwMmZzaWduYXR1cmUgOxhZLQzYw8DK9HPSEBK_iwci6VQFuaa3s6D0N4DcV1cK&from=s8_4_2_1_1_1&timeout=30000")
			.headers(headers_3)
			.check(bodyBytes.is(RawFileBody("RecordedSimulatecreatetchat_0022_response.txt"))))
