...
export nodes="tai@10.0.5.119 tai@10.0.5.120" 
role=${role:-"ai i"}
export roles=($role)

export NUM_MINIONS=${NUM_MINIONS:-2}

export SERVICE_CLUSTER_IP_RANGE=${SERVICE_CLUSTER_IP_RANGE:-192.168.2.0/24}  # formerly PORTAL_NET
...
DOCKER_OPTS=${DOCKER_OPTS:-"--registry-mirror http://172.19.10.25:5000"}

# Optional: Install cluster DNS.
ENABLE_CLUSTER_DNS=true
# DNS_SERVER_IP must be a IP in SERVICE_CLUSTER_IP_RANGE
DNS_SERVER_IP=${DNS_SERVER_IP:-"192.168.2.76"}
